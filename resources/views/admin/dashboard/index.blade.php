...
@if(session('show_dashboard_loader'))
   <div id="dashboard-loader" style="
    ...
    width: 100%;
    height: 100%;
    background: rgba(255, 255, 255, 0.7); /* Changed to 0.7 for more transparency */
    z-index: 9999;
    display: flex;
...
">
    <div style="
        border: 8px dashed #dae7ff; /* Changed to 'dashed' */
        border-top: 8px dashed #3498db; /* Changed to 'dashed' */
        border-radius: 50%;
        width: 60px;
        height: 60px;
